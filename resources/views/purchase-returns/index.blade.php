...
<div class="flex items-center justify-between mb-6">
    ...
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Purchase Returns</h1>
        <p class="text-gray-500 text-sm">Manage all returned purchases</p>
    </div>
    ...
    <x-table>
        ...
        <thead class="bg-gray-100">
            <tr>
                ...
                <th class="p-4 text-left">Purchase Invoice</th>
                    ...
                    <td class="p-4 text-center">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <h2 class="text-xl font-bold text-gray-800 mb-3">Delete Purchase Return</h2>

...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-black text-gray-800 uppercase tracking-tight">Create Product</h1>
        <p class="text-gray-500 text-sm tracking-wide">Create new product for your store</p>
    </div>
        ...
        >
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div class="lg:col-span-8 space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <input type="text" name="name" placeholder="Enter Name" required class="w-full border border-gray-200 rounded-2xl px-5 py-3.5 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all placeholder:text-gray-300">
                        </div>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <div class="flex">
                                <input type="text" name="sku" placeholder="Enter Code" required class="w-full border border-gray-200 rounded-2xl px-5 py-3.5 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all placeholder:text-gray-300">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <textarea name="description" rows="5" placeholder="Enter Note" class="w-full border border-gray-200 rounded-2xl px-5 py-3.5 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all placeholder:text-gray-300"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-4 space-y-8">
                    {{-- Images --}}
                    <div>
                        <label class="block mb-2 text-xs font-black text-gray-500 uppercase tracking-widest">Multiple Image:</label>
                        <div class="relative group">
                            <input type="file" name="images[]" multiple class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" onchange="const count = this.files.length; this.nextElementSibling.querySelector('.file-text').innerText = count > 1 ? count + ' files chosen' : this.files[0].name;">
                            <div class="flex items-center border border-gray-200 rounded-2xl overflow-hidden group-hover:border-indigo-300 transition-all">
                                <div class="bg-gray-100 px-4 py-3.5 text-sm font-bold text-gray-600 border-r border-gray-200">Choose Files</div>
                                <div class="px-4 py-3.5 text-sm text-gray-400 file-text truncate">No file chosen</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <template x-for="type in selectedVariationTypes" :key="type">
                            <tr>
                                ...
                                <td class="p-5">
                                    <input type="number" step="0.01" :name="'variation_cost['+type+']'" placeholder="0.00" class="w-full border border-gray-200 rounded-2xl px-5 py-3 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all text-sm font-bold text-gray-700">
                                </td>
                                <td class="p-5">
                                    <input type="number" step="0.01" :name="'variation_price['+type+']'" placeholder="0.00" class="w-full border border-gray-200 rounded-2xl px-5 py-3 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all text-sm font-bold text-gray-700">
                                </td>
                                <td class="p-5">
                                    <input type="number" :name="'variation_opening_stock['+type+']'" placeholder="0" class="w-full border border-gray-200 rounded-2xl px-5 py-3 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all text-sm font-bold text-gray-700">
                                </td>
                                <td class="p-5">
                                    <input type="number" :name="'variation_stock_alert['+type+']'" value="10" class="w-full border border-gray-200 rounded-2xl px-5 py-3 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all text-sm font-bold text-gray-700">
                                </td>
                                <td class="p-5">
                                    <input type="text" :name="'variation_sku['+type+']'" placeholder="Code" class="w-full border border-gray-200 rounded-2xl px-5 py-3 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all text-sm font-bold text-gray-700">
                                </td>
                            </tr>
                        </template>
                    </tbody>
            ...
            <div x-show="productType === 'single'" x-transition class="mt-10 grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <input type="number" step="0.01" name="cost_price" placeholder="0.00" class="w-full border border-gray-200 rounded-2xl px-5 py-3.5 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all font-bold text-gray-700">
                </div>
                <div>
                    <label class="block mb-2 text-xs font-black text-gray-500 uppercase tracking-widest">Selling Price:*</label>
                    <input type="number" step="0.01" name="selling_price" placeholder="0.00" class="w-full border border-gray-200 rounded-2xl px-5 py-3.5 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all font-bold text-gray-700">
                </div>
                <div>
                    <label class="block mb-2 text-xs font-black text-gray-500 uppercase tracking-widest">Opening Stock:*</label>
                    <input type="number" name="opening_stock" placeholder="0" class="w-full border border-gray-200 rounded-2xl px-5 py-3.5 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all font-bold text-gray-700">
                </div>
                <div>
                    <label class="block mb-2 text-xs font-black text-gray-500 uppercase tracking-widest">Stock Alert:*</label>
                    <input type="number" name="stock_alert" value="10" class="w-full border border-gray-200 rounded-2xl px-5 py-3.5 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all font-bold text-gray-700">
                </div>
            </div>

<div 
    ...
    class="w-72 bg-white shadow-xl h-full flex flex-col border-r border-gray-100"
>
    <!-- Logo Section -->
    ...
    <!-- Navigation Menu -->
    <div class="flex-1 px-4 py-2 overflow-y-auto no-scrollbar">
        <ul class="space-y-1.5">
            ...
            <li class="space-y-1">
                <a 
                    ...
                    class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ request()->routeIs('settings.*') ? 'bg-indigo-50 text-indigo-600 font-bold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900' }}"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">

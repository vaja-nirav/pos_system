...
<div class="max-w-6xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-500 text-sm">Define a new system role and its permissions</p>
        </div>
    ...
    <form action="{{ route('roles.store') }}" method="POST">
        ...
        <x-card class="mb-6">
            <div class="max-w-md">
                ...
                <x-input type="text" name="name" placeholder="Enter role name (e.g. Manager)" value="{{ old('name') }}" required />
                @error('name')
        ...
        <x-card>
            ...
            <div class="flex gap-3 mt-8">
                <x-button type="submit" class="px-10">Save Role</x-button>
                <a href="{{ route('roles.index') }}">
